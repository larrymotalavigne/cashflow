  ...
  template: `
    <p-toolbar class="theme-bg-card theme-shadow-sm border-b theme-border">
      <div class="flex align-items-center justify-between w-full relative">
        ...
        <div
          class="absolute left-1/2 transform -translate-x-1/2 flex align-items-center gap-2"
        >
          <img src="logo.svg" alt="Logo" class="w-8 h-8 sm:w-10 sm:h-10" />
          <span class="text-lg sm:text-xl font-semibold theme-text-primary">{{
            translationService.translate("game.dashboard")
          }}</span>
        </div>
    ...
    >
      <div class="space-y-4 sm:space-y-6 animate-fade-in">
            ...
            <ng-template pTemplate="content">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="theme-bg-muted rounded-lg p-4 theme-border border">
                  ...
                  >
                    <i
                      class="pi pi-cog mr-2 text-secondary-600 dark:text-secondary-400"
                    ></i>
                    Actions Rapides
                  </h3>
        ...
        <div class="flex flex-wrap gap-3 justify-center">
          <p-button
            [label]="
              'Détails Financiers ' + (showFinancialDetails ? '🔼' : '🔽')
            "
        ...
        <div [@panelExpand]="showPortfolio ? 'expanded' : 'collapsed'">
          @if (showPortfolio) {
            <app-drag-drop-portfolio></app-drag-drop-portfolio>
          }
        </div>
      </div>
