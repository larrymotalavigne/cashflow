  ...
  private translations: Record<Language, Translations> = {
    fr: {
      ...
      dialogs: {
        ...
        confirmBackMessage:
          "Êtes-vous sûr de vouloir retourner au menu principal ? Votre progression sera sauvegardée automatiquement.",
        confirmRejectTitle: "Rejeter l'opportunité",
        confirmRejectMessage:
          "Êtes-vous sûr de vouloir rejeter cette opportunité d'investissement ?",
        purchaseSuccessTitle: "Achat réussi !",
        purchaseSuccessMessage:
          "Votre investissement a été ajouté à votre portfolio",
      ...
      startup: {
        ...
        welcomeDesc:
          "Ce jeu vous permet de simuler votre parcours financier, de l'emploi à l'indépendance financière.",
        gameDescription:
          "Ce jeu vous permet de simuler votre parcours financier, de l'emploi à l'indépendance financière.",
        howToPlay: "Comment jouer:",
        step1:
          "Choisissez un métier - Chaque métier a un salaire différent qui détermine votre revenu mensuel.",
        step2:
          "Définissez votre âge - Votre âge influence le nombre de tours que vous aurez pour atteindre l'indépendance financière.",
        step3:
          "Capital de départ - C'est l'argent avec lequel vous commencez le jeu.",
        step4: "Nom - Entrez votre nom ou générez-en un aléatoirement.",
        objective: "Objectif du jeu:",
        objectiveDesc:
          "L'objectif est d'atteindre l'indépendance financière, c'est-à-dire lorsque vos revenus passifs dépassent vos dépenses.",
        duringGame: "Pendant le jeu:",
        gameStep1:
          "À chaque tour, vous recevez votre salaire et payez vos dépenses",
        gameStep2:
          "Vous pouvez acheter des investissements pour générer des revenus passifs",
        ...
        difficulties: {
          easy: {
            label: "Facile",
            description:
              "Pour les débutants - salaires plus élevés, dépenses réduites, événements moins fréquents",
          },
          normal: {
            label: "Normal",
          ...
          hard: {
            label: "Difficile",
            description:
              "Pour les joueurs expérimentés - dépenses plus élevées, revenus réduits",
          },
          expert: {
            label: "Expert",
            description:
              "Défi ultime - conditions très difficiles, événements fréquents",
          },
        },
      },
      game: {
        ...
        victoryMessage:
          "Félicitations ! Vous avez atteint la liberté financière !",
        export: {
    ...
    en: {
      ...
      dialogs: {
        ...
        confirmBackMessage:
          "Are you sure you want to return to the main menu? Your progress will be saved automatically.",
        confirmRejectTitle: "Reject Opportunity",
        confirmRejectMessage:
          "Are you sure you want to reject this investment opportunity?",
      ...
      startup: {
        ...
        welcomeDesc:
          "This game allows you to simulate your financial journey from employment to financial independence.",
        gameDescription:
          "This game allows you to simulate your financial journey from employment to financial independence.",
        howToPlay: "How to play:",
        step1:
          "Choose a job - Each job has a different salary that determines your monthly income.",
        step2:
          "Set your age - Your age influences the number of turns you will have to reach financial independence.",
        step3: "Starting capital - This is the money you start the game with.",
        step4: "Name - Enter your name or generate one randomly.",
        objective: "Game objective:",
        objectiveDesc:
          "The goal is to achieve financial independence, which means your passive income exceeds your expenses.",
        ...
        difficulties: {
          easy: {
            label: "Easy",
            description:
              "For beginners - higher salaries, reduced expenses, less frequent events",
          },
          normal: {
            label: "Normal",
          ...
          hard: {
            label: "Hard",
            description:
              "For experienced players - higher expenses, reduced income",
          },
          expert: {
            label: "Expert",
            description:
              "Ultimate challenge - very difficult conditions, frequent events",
          },
        },
      },
      game: {
    ...
    es: {
      ...
      dialogs: {
        ...
        confirmBackMessage:
          "¿Estás seguro de que quieres volver al menú de inicio? Tu progreso actual se perderá.",
        confirmResetTitle: "Reiniciar juego",
        confirmResetMessage:
          "¿Estás seguro de que quieres reiniciar el juego? Todos los progresos se perderán.",
        confirmSellTitle: "Vender inversión",
        confirmSellMessage:
          "¿Estás seguro de que quieres vender esta inversión?",
        confirmBuyTitle: "Comprar inversión",
        confirmBuyMessage:
          "¿Estás seguro de que quieres comprar esta inversión?",
      },
      startup: {
      ...
      game: {
        ...
        winCondition:
          "¡Felicitaciones! Has alcanzado el objetivo de ingresos pasivos",
        winMessage:
          "¡Has ganado el juego! Tus ingresos pasivos exceden tus gastos.",
    ...
    de: {
      ...
      dialogs: {
        ...
        confirmBackMessage:
          "Bist du sicher, dass du zum Startmenü zurückkehren möchtest? Dein aktueller Fortschritt geht verloren.",
        confirmResetTitle: "Spiel zurücksetzen",
        confirmResetMessage:
          "Bist du sicher, dass du das Spiel zurücksetzen möchtest? Aller Fortschritt geht verloren.",
        confirmSellTitle: "Investition verkaufen",
        confirmSellMessage:
          "Bist du sicher, dass du diese Investition verkaufen möchtest?",
        confirmBuyTitle: "Investition kaufen",
        confirmBuyMessage:
          "Bist du sicher, dass du diese Investition kaufen möchtest?",
      },
      startup: {
      ...
      game: {
        ...
        winCondition:
          "Herzlichen Glückwunsch! Du hast das Ziel für passives Einkommen erreicht",
        winMessage:
          "Du hast das Spiel gewonnen! Dein passives Einkommen übersteigt deine Ausgaben.",
  ...
  translate(key: string): string {
    ...
    for (const k of keys) {
      if (current && typeof current === "object" && k in current) {
        ...
        console.warn(
          `Translation key not found: ${key} for language ${this.language()}`,
        );
