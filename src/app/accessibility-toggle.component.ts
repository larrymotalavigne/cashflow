...
export class AccessibilityToggleComponent {
  ...
  private createToggleTemplate(
    settingKey: keyof typeof this.accessibilityService.settings.value,
  ) {
    return `
    ...
    if (this.accessibilityService.settings().screenReaderEnabled) {
      this.accessibilityService.announce(
        current
          ...
          : this.translationService.t("accessibility.highContrastEnabled"),
      );
    }
  }
  ...
  toggleReducedMotion(): void {
    ...
    if (this.accessibilityService.settings().screenReaderEnabled) {
      this.accessibilityService.announce(
        current
          ? "Motion restored"
          : this.translationService.t("accessibility.reducedMotionEnabled"),
      );
    }
  }
