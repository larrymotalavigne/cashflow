...
export class ExportService {
  ...
  exportToCSV(): void {
    ...
    this.downloadFile(
      csvContent,
      `cashflow-history-${this.gameService.name}-${new Date().toISOString()}.csv`,
      "text/csv",
    );
  }
  ...
  exportSummaryReport(): void {
    ...
    this.downloadFile(
      report,
      `cashflow-summary-${this.gameService.name}-${new Date().toISOString()}.txt`,
      "text/plain",
    );
  }
  ...
  exportToJSON(): void {
    ...
    this.downloadFile(
      jsonContent,
      `cashflow-complete-${this.gameService.name}-${new Date().toISOString()}.json`,
      "application/json",
    );
  }
